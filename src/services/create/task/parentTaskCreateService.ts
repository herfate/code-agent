...
import {
  ...
  BUSINESS_CORE_PARENT_TASK_TYPE,
...
function runWorkflowByTaskType(
  ...
  switch (taskType) {
    ...
    case DEV_REVIEW_NO_TEST_PARENT_TASK_TYPE:
      return runDevReviewNoTestParentTaskWorkflow(db, { ...ctx, taskType });
    case FUNC_TEST_PARENT_TASK_TYPE:
    ...
    case BUSINESS_CORE_PARENT_TASK_TYPE:
      return runBusinessCoreParentTaskWorkflow(db, { ...ctx, taskType });
    default:
