...
```
GET http://trade-mock.{{testEnv}}.k8s.howbuy.com/api/trade/selectMockPageList
```
...
```
POST http://trade-mock.{{testEnv}}.k8s.howbuy.com/api/trade/saveMock
```
...
```powershell
Invoke-RestMethod -Uri "http://trade-mock.{{testEnv}}.k8s.howbuy.com/api/trade/selectMockPageList" `
